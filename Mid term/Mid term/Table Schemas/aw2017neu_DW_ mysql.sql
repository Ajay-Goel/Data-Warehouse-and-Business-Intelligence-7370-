--
-- Target: aw2017neu_DW (AdventureWorksDW)
-- dbms:       MySQL 
-- Modified: 2018-10-28
-- Rick Sherman
-- 
...
/****** Object:  Table DimSalesTerritory    ******/
...
CREATE TABLE DimProductCostHistory(          
  ProductCostHistorySK        int AUTO_INCREMENT  NOT NULL,
...
CREATE TABLE DimProductPriceHistory(          
  ProductPriceHistorySK        int AUTO_INCREMENT  NOT NULL,
...
/****** Object:  Table DimVendorContacts******/
...
/****** Object:  Table FactPurchases_Rejects ******/

CREATE TABLE FactPurchases_Rejects(
     PurchaseSK              int AUTO_INCREMENT NOT NULL,
     PurchaseOrderID         int  NULL,   -- AK
     PurchaseOrderDetailID   int  NULL,   -- AK
     Status                           int  NULL,
     EmployeeSK              int NULL,
     VendorSK                int NULL,
     ShipMethodSK            int NULL,
     ...
     StockedQty              int  NULL,
     LineTaxAmount           numeric(15,2)  NULL,
     LineFreight             numeric(15,2)  NULL,
     LineTotalDue            numeric(15,2) NULL,
...
(
        ...
        -- WorkOrderSK int  NULL,   -- modified 2018-07-17
...
/****** Object:  Table DimCustomerPerson ******/
...
/****** Object:  Table DimPromotion    Script Date: 6/26/2016 7:16:54 AM ******/
...
/****** Object:  Table FactInternetSales    ******/
...
--------------------- additional SCD processing

CREATE TABLE DimProductCostHistory_Alteryx
(          
  ProductCostHistorySK        int AUTO_INCREMENT  NOT NULL,
...
CREATE TABLE DimProductPriceHistory_Alteryx
(          
  ProductPriceHistorySK        int AUTO_INCREMENT  NOT NULL,
...
CREATE TABLE DimProductCostHistory_Talend
(          
  ProductCostHistorySK        int AUTO_INCREMENT  NOT NULL,
...
CREATE TABLE DimProductPriceHistory_Talend
(          
  ProductPriceHistorySK        int AUTO_INCREMENT  NOT NULL,
...
CREATE TABLE DimProductCostHistory_SSIS
(          
  ProductCostHistorySK        int AUTO_INCREMENT  NOT NULL,
...
CREATE TABLE DimProductPriceHistory_SSIS
(          
  ProductPriceHistorySK        int AUTO_INCREMENT  NOT NULL,
